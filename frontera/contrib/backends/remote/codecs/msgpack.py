...
class Encoder(BaseEncoder):
    ...
    def encode_page_crawled(self, response):
        return packb(['pc', _prepare_response_message(response, self.send_body)])

    def encode_links_extracted(self, request, links):
        return packb(['le', _prepare_request_message(request), [_prepare_request_message(link) for link in links]])
